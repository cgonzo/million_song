...
hadoop fs -rmr cover_song3
hadoop jar $SJAR -mapper "/usr/bin/python cover_song3.py map" -reducer "/usr/bin/python cover_song3.py reduce" -input cover_song2 -output cover_song3 -file "cover_song3.py" -file "common.py"
