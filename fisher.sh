...
#hadoop jar $SJAR -mapper "/usr/bin/python fisher_classify.py map" -reducer "/usr/bin/python fisher_classify.py reduce" -input data -output bayes_classify -file "fisher_classify.py" -file "common.py" -file "artists_train.txt" -cacheFile "hdfs://master:54310/user/root/build_fisher/#build_fisher"
