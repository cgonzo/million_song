...
hadoop jar $SJAR -jobconf mapred.task.timeout=1800000 -numReduceTasks 40 -mapper "/usr/bin/python build_fisher.py map" -reducer "/usr/bin/python build_fisher.py reduce"  -input data -output build_fisher -file "build_fisher.py" -file "common.py" -file "artists_train.txt" -file "artist_by_most_popular_term_sorted.txt"
